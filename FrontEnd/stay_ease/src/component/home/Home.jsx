        ...
        <div className="home">
            <section>
                <header className="header-banner">
                    <img src="./assets/images/hotel.webp" alt="StayEase Hotel" className="hotel-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="stayease-color">StayEase Hotel</span>
                        </h1>
                        <h3>
                            Step into heaven of comfort and care
                        </h3>
                    </div>
                </header>
            </section>
            ...
            <h2 className="home-services">Services at <span className="stayease-color">StayEase Hotel</span></h2>
